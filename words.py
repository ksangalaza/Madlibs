...
#CONNECTING CLASSES TO MONGODB
client = MongoClient()
db_Madlibs = client.Madlibs
madlibs_data = db_Madlibs.madlibs_data

#CLASS FUNCTION TO WITE INTO MONGODB ARCHIVES
...
#CLASS FUNCTION TO DELETE DATA IN MONGODB ARCHIVES
def delete_archives(self):
    
        x = madlibs_data.delete_many(
            {
            "Noun": self.noun,
        ...
        return "Successfully deleted" + x + "from the database"
